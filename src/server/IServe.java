...
public interface IServe {
    /**
     * @param requestURI the Request-URI from the associated GET request
     * @return an array of <code>byte</code>s containing the requested data
     * @throws HTTPFileNotFoundException     if the file specified by the Request-URI does not exist
     * @throws HTTPRuntimeException          if the file specified by the Request-URI is executable but
     *                                       did not execute correctly
     * @throws HTTPPermissionDeniedException if the file specified by the Request-URI is not permissioned
    ...
    /**
     * @param requestURI      the Request-URI from the associated conditional GET request
     * @param ifModifiedSince a Date Object containing the date from the If-Modified-Since
     *                        header field
     * @return an array of <code>byte</code>s containing the requested data
     * @throws HTTPFileNotFoundException     if the file specified by the Request-URI does not exist
     * @throws HTTPRuntimeException          if the file specified by the Request-URI is executable but
    ...
    /**
     * @param requestURI the Request-URI from the associated HEAD request
     * @return an array of <code>byte</code>s containing the requested data
     * @throws HTTPFileNotFoundException     if the file specified by the Request-URI does not exist
     * @throws HTTPRuntimeException          if the file specified by the Request-URI is executable but
     *                                       did not execute correctly
    ...
    /**
     * @param requestURI the Request-URI from the associated POST request
     * @param postData   an array of <code>byte</code>s containing the POST data from
     *                   the POST request
     * @return an array of <code>byte</code>s containing the requested data
     * @throws HTTPFileNotFoundException     if the file specified by the Request-URI does not exist
     * @throws HTTPRuntimeException          if the file specified by the Request-URI is executable but
